namespace IRRIGATIONDLL.Models
{
    ...
    [Table("LOANORDER")]
    public partial class LOANORDER : PARENTENTITY
    {
        //مستفيد
        public LOANORDER() {
        ...
        //طريقة الري
        public decimal IRRIMETId { get; set; }
        [ForeignKey("IRRIMETId")]
        public virtual CONSTANT IRRIGATIONMETHOD { get; set; }
        ...
        //نوع مستند الحيازة
        public decimal OWNDOCTYId { get; set; }
        [ForeignKey("OWNDOCTYId")]
        public virtual CONSTANT OWNERDOCTYPE { get; set; }

        //طريقة تسديد القرض
        public decimal LOANPAYTYPId { get; set; }
        [ForeignKey("LOANPAYTYPId")]
        public virtual CONSTANT LOANPAYMENTTYPE { get; set; }
       //عدد الوثائق المرفقة
